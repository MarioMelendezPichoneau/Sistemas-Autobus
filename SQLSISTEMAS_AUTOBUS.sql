...
END;
  ...
  --INSERTAR CHOFER--
CREATE OR REPLACE PROCEDURE SP_INSERTARCHOFER (c_ID_CHOFER in CHOFER.ID_CHOFER%TYPE,
                          c_NOMBRE VARCHAR,
                          c_APELLIDO VARCHAR,
                          c_FECHA VARCHAR,
                          c_CEDULA date)
IS 
BEGIN
    INSERT INTO CHOFER(NOMBRE,APELLIDO,FECHA,CEDULA) VALUES (c_NOMBRE,c_APELLIDO,c_FECHA,c_CEDULA);

END;


--EDITAR CHOFER--
CREATE OR REPLACE PROCEDURE SP_EDITARCHOFER (_ID_CHOFER in CHOFER.ID_CHOFER%TYPE,
                          _NOMBRE VARCHAR,
                          _APELLIDO VARCHAR,
                          _FECHA VARCHAR,
                          _CEDULA date)
IS 
BEGIN
    UPDATE CHOFER SET NOMBRE =_NOMBRE, APELLIDO =_APELLIDO, FECHA=_FECHA, CEDULA=_CEDULA
WHERE ID_CHOFER=_ID_CHOFER;
...
CREATE OR REPLACE PROCEDURE SP_ELIMINARCHOFER (e_id in CHOFER.ID_CHOFER%TYPE)
IS
BEGIN
    delete from empleados where id_emp=e_id;
END;

INSERT INTO CHOFER VALUES('PAIQUER', 'ORTIZ', '1994-03-11', '402-14234518-9');

INSERT INTO CHOFER (NOMBRE,APELLIDO,FECHA,CEDULA) VALUES('PAIQUER', 'ORTIZ', '1994-03-11', '402-14234518-9');
